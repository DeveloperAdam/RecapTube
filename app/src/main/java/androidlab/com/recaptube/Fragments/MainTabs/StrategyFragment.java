...
public class StrategyFragment extends Fragment implements View.OnClickListener {
    ...
    Button brainstormed,developed,explored,identified,outlined,reviewed,straitegized,suggested,recomended;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        straitegized=(Button)view.findViewById(R.id.straitegized);
        suggested=(Button)view.findViewById(R.id.suggested);
        recomended=(Button)view.findViewById(R.id.recomended);
        ...
        straitegized.setOnClickListener(this);
        suggested.setOnClickListener(this);
        recomended.setOnClickListener(this);
