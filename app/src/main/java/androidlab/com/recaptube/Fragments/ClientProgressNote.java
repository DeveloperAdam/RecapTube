...
public class ClientProgressNote extends Fragment implements View.OnClickListener {
    ...
    ToggleButton toggleButtonClient,toggleButtonFacilitator,
            toggleButtonTherapist,toggleButtonCFS,toggleButtonParentPartner,toggleButton12,toggleButton,toggleButton2,button4,button3
            ,buttonAddPerson,toggleButton1122;
        ...
        toggleButtonClient.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    if (teamMember>1 && familyMembers+otherProfessional+friends>0)
                    {
                        texteffectbutton=textPreviewIntroduction.getText().toString();
                        if (texteffectbutton.contains(CFT))
                        {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (toggleButton12.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
        ...
        toggleButton1122.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if(toggleButton1122.getText().toString().contains("friend")||toggleButton1122.getText().toString().contains("neighbor"))
                    {
                        friends++;
                    }
                    else
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (toggleButton1122.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if(toggleButton.getText().toString().contains("friend")||toggleButton.getText().toString().contains("neighbor"))
                    {
                        friends++;
                    }
                    else
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (toggleButton.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
        ...
        toggleButton2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if(toggleButton2.getText().toString().contains("friend")||toggleButton2.getText().toString().contains("neighbor"))
                    {
                        friends++;
                    }
                    else
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (toggleButton2.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
        ...
        button4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if(button4.getText().toString().contains("friend")||button4.getText().toString().contains("neighbor"))
                    {
                        friends++;
                    }
                    else
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (button4.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
        ...
        button3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if(button3.getText().toString().contains("friend")||button3.getText().toString().contains("neighbor"))
                    {
                        friends++;
                    }
                    else
                    ...
                    if (teamMember> 1 || otherProfessional>0)
                    {
                        ...
                        if (button3.getText().toString().contains("teacher"))
                        {
                            if (toggleButtonFacilitator.isChecked()&&toggleButtonTherapist.isChecked()&&toggleButtonParentPartner.isChecked())
                            {
                                if (texteffectbutton.contains(allStaff))
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if (teamMember> 1 || otherProfessional> 1)
                    {
                        ...
                        if (toggleButtonFacilitator.getText().toString().contains("teacher"))
                        {
                            if (texteffectbutton.contains(CFT))
                            {
                                textPreviewIntroduction.setText(texteffectbutton+"the "+toggleButtonFacilitator.getText()+", ");
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if (teamMember> 1 || otherProfessional> 1)
                    {
                        ...
                        if (toggleButtonTherapist.getText().toString().contains("teacher"))
                        {
                            if (texteffectbutton.contains(CFT))
                            {
                                textPreviewIntroduction.setText(texteffectbutton+"the "+toggleButtonTherapist.getText()+", ");
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    if (teamMember> 1 || otherProfessional>1)
                    {
                        ...
                        if (toggleButtonParentPartner.getText().toString().contains("teacher"))
                        {
                            if (texteffectbutton.contains(CFT))
                            {
                                textPreviewIntroduction.setText(texteffectbutton+"the "+toggleButtonParentPartner.getText()+", ");
